      ...
      <div className="grids">
        ...
        <div className="one">
          <div className="oneframe  flex flex-col">
            ...
            <button className="mt-10 rounded-md bg-white px-3.5 py-2.5 text-md font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50">Learn more</button>
            </Link>
          </div>
        </div>
