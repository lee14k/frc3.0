          ...
          <div className="lg:mt-6 lg:w-80 lg:flex-none">
            ...
            <figure className="mt-10">
              <blockquote className="text-lg font-semibold leading-8 text-gray-900">
                <p>
                  “We had an incredible time performing at the Falling Rock Cafe. Cozy atmosphere, great coffee, and a wonderful audience. We can't wait to come back!”
                </p>
              </blockquote>
              <figcaption className="mt-10 flex gap-x-6">
            
                <div>
                  <div className="text-base font-semibold text-gray-900">John Doe</div>
                  <div className="text-sm leading-6 text-gray-600 mb-60">Band name</div>
                </div>
              </figcaption>
            </figure>
          </div>
